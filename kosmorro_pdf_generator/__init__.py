...
def generate_pdf(
    ...
    html = parse_template(
        ...
        introduction_1=f"This document summarizes the ephemerides and the events of {fmt_date(for_date, locale)}. It aims to help you to prepare your observation session. All the hours are given in UTC+1.",
